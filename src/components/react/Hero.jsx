      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative">
        <div className="text-center">
          <div className="mb-8">
            ...
            <div className="h-1 w-32 mx-auto mt-6 rounded-full bg-gradient-to-r from-violet-500 via-fuchsia-500 to-pink-500"></div>
          </div>
          
          <p className="text-xl sm:text-3xl text-gray-400 mb-12 font-light">
          ...
          <div className="relative inline-flex group">
            ...
            <button className="relative px-8 py-4 bg-gray-900/30 backdrop-blur-xl rounded-lg leading-none flex items-center space-x-2 border border-violet-500/20">
              <span className="text-gray-300 group-hover:text-white transition duration-200 text-lg">
                Ver Proyectos
              </span>
